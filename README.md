...
`dnase.machine_sizes` specifies the desired compute size for specific steps of the pipeline (when run on platforms where custom instances can be specified like Google Cloud).
```
"dnase.machine_sizes": {
    "qc": "medium2x",
    "normalize": "medium2x",
